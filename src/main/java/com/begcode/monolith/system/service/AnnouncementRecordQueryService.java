...
public class AnnouncementRecordQueryService implements QueryService<AnnouncementRecord> {
    ...
    public <T> List<T> getFieldByCriteria(Class<T> clazz, String fieldName, Boolean distinct, AnnouncementRecordCriteria criteria) {
        return announcementRecordRepository.selectObjs(createQueryWrapperNoJoin(criteria).select(fieldName));
    }
    ...
    public QueryWrapper<AnnouncementRecord> createQueryWrapper(AnnouncementRecordCriteria criteria) {
        ...
        QueryWrapper<AnnouncementRecord> queryWrapper = new DynamicJoinQueryWrapper<>(AnnouncementRecordCriteria.class, fields);
        ...
        fieldNameMap.forEach((key, value) -> {
            ...
            if (column.startsWith("self.")) {
                ...
                if (queryWrapper instanceof DynamicJoinQueryWrapper) {
                    DynamicJoinQueryWrapper<AnnouncementRecordCriteria, AnnouncementRecord> dynamicQuery = (DynamicJoinQueryWrapper<
                            AnnouncementRecordCriteria,
                            AnnouncementRecord
                        >) queryWrapper;
                    dynamicQuery
                        .getAnnoJoiners()
