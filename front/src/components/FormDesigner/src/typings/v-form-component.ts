...
export type PickAntFormConfig = Pick<
  FormProps,
  'layout' | 'size' | 'colon' | 'labelAlign' | 'disabled' | 'labelCol' | 'wrapperCol' | 'hideRequiredMark'
>;
...
export interface AForm {
  ...
  /**
   * The layout of label. You can set span offset to something like {span: 3, offset: 12} or sm: {span: 3, offset: 12} same as with <a-col>
   * @type IACol
   */
  labelCol: IACol;
