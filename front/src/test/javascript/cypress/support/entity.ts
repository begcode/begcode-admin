...
export const entityCreateButtonSelector = 'div.vxe-tools--wrapper > button > i.vxe-icon-add';
...
export const entityDetailsBackButtonSelector = 'button.ant-drawer-close';
...
export const listSearchInputSelector = '[data-cy="listSearchInput"]';
export const listSearchButtonSelector = '[data-cy="listSearchButton"]';
export const listSearchMoreSelector = '[data-cy="listSearchMore"]';
export const listSearchFormSelector = '[data-cy="listSearchForm"]';
export const searchFormSubmitSelector = '[data-cy="searchFormSubmit"]';
export const searchFormResetSelector = '[data-cy="searchFormReset"]';
export const formAdvanceToggleSelector = '[data-cy="formAdvanceToggle"]';
...
Cypress.Commands.add('getEntityDeleteDialogHeading', (entityInstanceName: string) => {
  return cy.get(`[data-cy-heading="${entityInstanceName}DeleteDialogHeading"]`);
});
