...
import UploadImageEdit from './components/form-component.vue';
import UploadImageDetail from './components/detail-component.vue';
...
const listData = ref<IUploadImage[]>([]);
  ...
  toolButtons: [
    {
      ...
      click: () => {
        ...
        popupConfig.containerProps.title = '新增上传图片';
        ...
        popupConfig.componentProps.is = shallowRefs.UploadImageEdit;
...
useSetShortcutButtons('OssUploadImageList', extraButtons);
...
const rowClick = ({ name, data }) => {
  ...
  if (operation?.click) {
    ...
    switch (name) {
      case 'edit':
        popupConfig.needSubmit = true;
        popupConfig.containerProps.title = '编辑上传图片';
      ...
      case 'detail':
        ...
        popupConfig.containerProps.showCancelBtn = true;
        popupConfig.componentProps.is = shallowRefs.UploadImageDetail;
        popupConfig.componentProps.entityId = row.id;
