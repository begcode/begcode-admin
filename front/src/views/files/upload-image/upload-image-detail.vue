<template>
  <PageWrapper v-bind="pageProps">
    <template #default>
      <UploadImageDescriptions ref="uploadImageDescriptionsRef" v-bind="descriptionProps"> </UploadImageDescriptions>
    </template>
...
import UploadImageDescriptions from './components/detail-component.vue';
...
const uploadImageDescriptionsRef = ref(null);
