<template>
  <PageWrapper v-bind="pageProps">
    <template #default>
      <UploadFileDescriptions ref="uploadFileDescriptionsRef" v-bind="descriptionProps"> </UploadFileDescriptions>
    </template>
...
import UploadFileDescriptions from './components/detail-component.vue';
...
const uploadFileDescriptionsRef = ref(null);
