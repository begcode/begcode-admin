<template>
  ...
  <div data-cy="SmsTemplateHeading">
    <a-card
...
import SmsTemplateDetail from './components/detail-component.vue';
...
const shallowRefs = {
  SmsTemplateEdit: shallowRef(SmsTemplateForm),
  SmsTemplateDetail: shallowRef(SmsTemplateDetail),
};
...
const apis = {
  ...
  import: apiService.files.smsTemplateService.importExcel,
  export: apiService.files.smsTemplateService.exportExcel,
...
useSetShortcutButtons('SystemSmsTemplateList', extraButtons);
...
function toolbarClick({ code }) {
  ...
  switch (code) {
      ...
      if (records?.length > 0) {
        ...
        Modal.confirm({
          ...
          okButtonProps: {
            ...
            'data-cy-heading': 'smsTemplateDeleteDialogHeading',
          } as any,
        });
      }
      break;
    ...
    case 'new':
      ...
      popupConfig.componentProps.is = shallowRefs.SmsTemplateEdit;
...
function rowClick({ name, data, params }) {
  ...
  if (operation?.click) {
    ...
    switch (name) {
      ...
      case 'edit':
        popupConfig.needSubmit = true;
        popupConfig.containerProps.title = '编辑消息模板';
      ...
      case 'detail':
        ...
        popupConfig.containerProps.showCancelBtn = true;
        popupConfig.componentProps.is = shallowRefs.SmsTemplateDetail;
        popupConfig.componentProps.entityId = row.id;
