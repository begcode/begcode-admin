  ...
  switch (code) {
    ...
    case 'new':
      const containerConfig: any = {
        componentName: shallowRef(SmsTemplateEdit),
        entityId: '',
        title: '新建',
        okText: '保存',
        cancelText: '取消',
  ...
  if (operation?.click) {
    ...
    switch (name) {
      case 'save':
        break;
      case 'edit':
        containerConfig.componentName = shallowRef(SmsTemplateEdit);
        containerConfig.title = '编辑消息模板';
      ...
      case 'detail':
        if (operation?.containerType) {
          containerConfig.componentName = shallowRef(SmsTemplateDetail);
