<template>
  <PageWrapper v-bind="pageProps">
    <template #default>
      <SmsTemplateDescriptions ref="smsTemplateDescriptionsRef" v-bind="descriptionProps"> </SmsTemplateDescriptions>
    </template>
...
import SmsTemplateDescriptions from './components/detail-component.vue';
...
const smsTemplateDescriptionsRef = ref(null);
