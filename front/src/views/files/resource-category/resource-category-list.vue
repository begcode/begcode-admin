  ...
  switch (code) {
    ...
    case 'new':
      const containerConfig: any = {
        componentName: shallowRef(ResourceCategoryEdit),
        entityId: '',
        title: '新建',
        okText: '保存',
        cancelText: '取消',
  ...
  if (operation?.click) {
    ...
    switch (name) {
      case 'save':
        break;
      case 'edit':
        containerConfig.componentName = shallowRef(ResourceCategoryEdit);
        containerConfig.title = '编辑资源分类';
      ...
      case 'detail':
        if (operation?.containerType) {
          containerConfig.componentName = shallowRef(ResourceCategoryDetail);
