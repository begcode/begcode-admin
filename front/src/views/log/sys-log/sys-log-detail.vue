<template>
  <PageWrapper v-bind="pageProps">
    <template #default>
      <SysLogDescriptions ref="sysLogDescriptionsRef" v-bind="descriptionProps"> </SysLogDescriptions>
    </template>
...
import SysLogDescriptions from './components/detail-component.vue';
...
const sysLogDescriptionsRef = ref(null);
