<template>
  <PageWrapper v-bind="pageProps">
    <template #default>
      <UReportFileDescriptions ref="uReportFileDescriptionsRef" v-bind="descriptionProps"> </UReportFileDescriptions>
    </template>
...
import UReportFileDescriptions from './components/detail-component.vue';
