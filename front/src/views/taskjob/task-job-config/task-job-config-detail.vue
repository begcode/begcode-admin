<template>
  <PageWrapper v-bind="pageProps">
    <template #default>
      <TaskJobConfigDescriptions ref="taskJobConfigDescriptionsRef" v-bind="descriptionProps"> </TaskJobConfigDescriptions>
    </template>
...
import TaskJobConfigDescriptions from './components/detail-component.vue';
...
const taskJobConfigDescriptionsRef = ref(null);
