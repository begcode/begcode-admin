<template>
  <PageWrapper v-bind="pageProps">
    <template #default>
      <AnnouncementRecordDescriptions ref="announcementRecordDescriptionsRef" v-bind="descriptionProps"> </AnnouncementRecordDescriptions>
    </template>
...
import AnnouncementRecordDescriptions from './components/detail-component.vue';
...
const announcementRecordDescriptionsRef = ref(null);
