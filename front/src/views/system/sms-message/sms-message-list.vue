...
import SmsMessageDetail from './components/detail-component.vue';
...
const shallowRefs = {
  SmsMessageEdit: shallowRef(SmsMessageForm),
  SmsMessageDetail: shallowRef(SmsMessageDetail),
};
...
const apis = {
  ...
  import: apiService.system.smsMessageService.importExcel,
  export: apiService.system.smsMessageService.exportExcel,
};
const pageConfig = {
  title: '短信消息列表',
...
useSetShortcutButtons('SystemSmsMessageList', extraButtons);
...
function toolbarClick({ code }) {
  ...
  switch (code) {
      ...
      if (records?.length > 0) {
        ...
        Modal.confirm({
          ...
          okButtonProps: {
            ...
            'data-cy-heading': 'smsMessageDeleteDialogHeading',
          } as any,
        });
      }
      break;
    ...
    case 'new':
      ...
      popupConfig.componentProps.is = shallowRefs.SmsMessageEdit;
...
function rowClick({ name, data, params }) {
  ...
  if (operation?.click) {
    ...
    switch (name) {
      ...
      case 'edit':
        popupConfig.needSubmit = true;
        popupConfig.containerProps.title = '编辑短信消息';
      ...
      case 'detail':
        ...
        popupConfig.containerProps.showCancelBtn = true;
        popupConfig.componentProps.is = shallowRefs.SmsMessageDetail;
        popupConfig.componentProps.entityId = row.id;
