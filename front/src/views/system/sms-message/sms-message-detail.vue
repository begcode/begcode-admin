<template>
  <PageWrapper v-bind="pageProps">
    <template #default>
      <SmsMessageDescriptions ref="smsMessageDescriptionsRef" v-bind="descriptionProps"> </SmsMessageDescriptions>
    </template>
...
import SmsMessageDescriptions from './components/detail-component.vue';
...
const smsMessageDescriptionsRef = ref(null);
