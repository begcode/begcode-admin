<template>
  <PageWrapper v-bind="pageProps">
    <template #default>
      <UserDescriptions ref="userDescriptionsRef" v-bind="descriptionProps"> </UserDescriptions>
    </template>
...
import UserDescriptions from './components/detail-component.vue';
...
const userDescriptionsRef = ref(null);
