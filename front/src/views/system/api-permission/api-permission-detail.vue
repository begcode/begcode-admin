<template>
  <PageWrapper v-bind="pageProps">
    <template #default>
      <ApiPermissionDescriptions ref="apiPermissionDescriptionsRef" v-bind="descriptionProps"> </ApiPermissionDescriptions>
    </template>
...
import ApiPermissionDescriptions from './components/detail-component.vue';
...
const apiPermissionDescriptionsRef = ref(null);
