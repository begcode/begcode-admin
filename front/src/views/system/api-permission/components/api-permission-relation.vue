<template>
  <div data-cy="ApiPermissionRelationHeading">
    <a-card
...
import ApiPermissionDetail from './detail-component.vue';
import ApiPermissionEdit from './form-component.vue';
...
const relationships = {
  'Authority.apiPermissions': 'authorities',
};
...
const apis = {
  ...
  findByParentId: apiService.system.apiPermissionService.treeByParentId,
...
const toolbarClick = ({ code }) => {
  ...
  switch (code) {
    ...
    case 'add': {
      ...
      popupConfig.componentProps.is = shallowRef(ApiPermissionList);
    ...
    case 'new':
      ...
      popupConfig.containerProps.showOkBtn = true;
      popupConfig.containerProps.showCancelBtn = true;
      popupConfig.componentProps.is = shallowRef(ApiPermissionEdit);
      popupConfig.componentProps.entityId = '';
      popupConfig.componentProps.baseData = props.baseData;
...
const rowClick = ({ name, data }) => {
  ...
  if (operation?.click) {
    ...
    switch (name) {
      case 'detail':
        popupConfig.componentProps.is = shallowRef(ApiPermissionDetail);
