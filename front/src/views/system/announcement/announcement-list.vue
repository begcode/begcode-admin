<template>
  ...
  <div data-cy="AnnouncementHeading">
    <a-card
...
const shallowRefs = {
  AnnouncementEdit: shallowRef(AnnouncementForm),
...
const apis = {
  ...
  import: apiService.system.announcementService.importExcel,
  export: apiService.system.announcementService.exportExcel,
};
const pageConfig = {
  title: '系统通告列表',
      ...
      if (records?.length > 0) {
        ...
        Modal.confirm({
          ...
          okButtonProps: {
            ...
            'data-cy-heading': 'announcementDeleteDialogHeading',
          } as any,
        });
      }
      break;
