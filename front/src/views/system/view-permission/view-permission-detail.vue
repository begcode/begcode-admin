<template>
  <PageWrapper v-bind="pageProps">
    <template #default>
      <ViewPermissionDescriptions ref="viewPermissionDescriptionsRef" v-bind="descriptionProps"> </ViewPermissionDescriptions>
    </template>
...
import ViewPermissionDescriptions from './components/detail-component.vue';
...
const viewPermissionDescriptionsRef = ref(null);
