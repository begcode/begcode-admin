<template>
  <PageWrapper v-bind="pageProps">
    <template #default>
      <DictionaryDescriptions ref="dictionaryDescriptionsRef" v-bind="descriptionProps"> </DictionaryDescriptions>
    </template>
...
import DictionaryDescriptions from './components/detail-component.vue';
...
const dictionaryDescriptionsRef = ref(null);
