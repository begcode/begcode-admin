<template>
  <PageWrapper v-bind="pageProps">
    <template #default>
      <SystemConfigDescriptions ref="systemConfigDescriptionsRef" v-bind="descriptionProps"> </SystemConfigDescriptions>
    </template>
...
import SystemConfigDescriptions from './components/detail-component.vue';
...
const systemConfigDescriptionsRef = ref(null);
