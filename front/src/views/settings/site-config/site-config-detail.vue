<template>
  <PageWrapper v-bind="pageProps">
    <template #default>
      <SiteConfigDescriptions ref="siteConfigDescriptionsRef" v-bind="descriptionProps"> </SiteConfigDescriptions>
    </template>
...
import SiteConfigDescriptions from './components/detail-component.vue';
...
const siteConfigDescriptionsRef = ref(null);
