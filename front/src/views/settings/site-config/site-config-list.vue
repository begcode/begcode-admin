...
import SiteConfigDetail from './components/detail-component.vue';
...
const shallowRefs = {
  SiteConfigEdit: shallowRef(SiteConfigForm),
  SiteConfigDetail: shallowRef(SiteConfigDetail),
...
const apis = {
  ...
  import: apiService.settings.siteConfigService.importExcel,
  export: apiService.settings.siteConfigService.exportExcel,
};
const pageConfig = {
  title: '网站配置列表',
...
useSetShortcutButtons('SystemSiteConfigList', extraButtons);
...
const toolbarClick = ({ code }) => {
  ...
  switch (code) {
    ...
    case 'new':
      ...
      popupConfig.componentProps.is = shallowRefs.SiteConfigEdit;
  ...
  if (operation?.click) {
    ...
    switch (name) {
      ...
      case 'detail':
        ...
        popupConfig.containerProps.showCancelBtn = true;
        popupConfig.componentProps.is = shallowRefs.SiteConfigDetail;
        popupConfig.componentProps.entityId = row.id;
      ...
      case 'itemsColumnView': {
        ...
        const rowParams = {
          ...
          gridCustomConfig: {
            ...
            hideColumns: ['siteConfig', 'dictionary'],
          },
          field: 'items',
          query: {
