<template>
  <PageWrapper v-bind="pageProps">
    <template #default>
      <BusinessTypeDescriptions ref="businessTypeDescriptionsRef" v-bind="descriptionProps"> </BusinessTypeDescriptions>
    </template>
...
import BusinessTypeDescriptions from './components/detail-component.vue';
...
const businessTypeDescriptionsRef = ref(null);
