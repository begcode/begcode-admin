<template>
  <PageWrapper v-bind="pageProps">
    <template #default>
      <SysFillRuleDescriptions ref="sysFillRuleDescriptionsRef" v-bind="descriptionProps"> </SysFillRuleDescriptions>
    </template>
...
import SysFillRuleDescriptions from './components/detail-component.vue';
...
const sysFillRuleDescriptionsRef = ref(null);
