<template>
  <PageWrapper v-bind="pageProps">
    <template #default>
      <PositionDescriptions ref="positionDescriptionsRef" v-bind="descriptionProps"> </PositionDescriptions>
    </template>
...
import PositionDescriptions from './components/detail-component.vue';
...
const positionDescriptionsRef = ref(null);
