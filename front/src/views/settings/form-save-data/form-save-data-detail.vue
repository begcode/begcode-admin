<template>
  <PageWrapper v-bind="pageProps">
    <template #default>
      <FormSaveDataDescriptions ref="formSaveDataDescriptionsRef" v-bind="descriptionProps"> </FormSaveDataDescriptions>
    </template>
...
import FormSaveDataDescriptions from './components/detail-component.vue';
...
const formSaveDataDescriptionsRef = ref(null);
