<template>
  <PageWrapper v-bind="pageProps">
    <template #default>
      <CommonFieldDataDescriptions ref="commonFieldDataDescriptionsRef" v-bind="descriptionProps"> </CommonFieldDataDescriptions>
    </template>
...
import CommonFieldDataDescriptions from './components/detail-component.vue';
...
const commonFieldDataDescriptionsRef = ref(null);
