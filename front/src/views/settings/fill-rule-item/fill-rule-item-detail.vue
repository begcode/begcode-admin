<template>
  <PageWrapper v-bind="pageProps">
    <template #default>
      <FillRuleItemDescriptions ref="fillRuleItemDescriptionsRef" v-bind="descriptionProps"> </FillRuleItemDescriptions>
    </template>
...
import FillRuleItemDescriptions from './components/detail-component.vue';
...
const fillRuleItemDescriptionsRef = ref(null);
