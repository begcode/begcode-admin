<template>
  <PageWrapper v-bind="pageProps">
    <template #default>
      <DepartmentDescriptions ref="departmentDescriptionsRef" v-bind="descriptionProps"> </DepartmentDescriptions>
    </template>
...
import DepartmentDescriptions from './components/detail-component.vue';
...
const departmentDescriptionsRef = ref(null);
