...
const allData: any[] = [];
const dataPath = path.resolve(__dirname, '../../data/task_job_config.csv');
const fakePath = path.resolve(__dirname, '../../fake-data/task_job_config.csv');
...
const baseApiUrl = '/api/task-job-configs';
