...
const allData: any[] = [];
const dataPath = path.resolve(__dirname, '../../data/sms_supplier.csv');
const fakePath = path.resolve(__dirname, '../../fake-data/sms_supplier.csv');
...
const baseApiUrl = '/api/sms-suppliers';
