...
const allData: any[] = [];
const dataPath = path.resolve(__dirname, '../../data/fill_rule_item.csv');
const fakePath = path.resolve(__dirname, '../../fake-data/fill_rule_item.csv');
...
const baseApiUrl = '/api/fill-rule-items';
