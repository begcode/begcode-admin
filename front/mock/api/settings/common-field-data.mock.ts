...
const allData: any[] = [];
const dataPath = path.resolve(__dirname, '../../data/common_field_data.csv');
const fakePath = path.resolve(__dirname, '../../fake-data/common_field_data.csv');
...
const baseApiUrl = '/api/common-field-data';
