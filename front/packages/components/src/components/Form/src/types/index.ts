...
export interface ComponentProps {
  ...
  SelectFile: CustomComponents['SelectFile'];
  ...
  AreaLinkage: CustomComponents['AreaLinkage'];
  RangeNumber: CustomComponents['RangeNumber'];
  InputPop: CustomComponents['InputPop'];
  AddInput: CustomComponents['AddInput'];
  EasyCron: CustomComponents['EasyCron'];
  Editor: CustomComponents['Editor'];
  CodeEditor: CustomComponents['CodeEditor'];
  AreaSelect: CustomComponents['AreaSelect'];
  RangeTime: CustomComponents['RangeTime'];
